...
if __name__ == '__main__':
  ...
  feature.visualize_beta_sheet_features('all', 'gauss_cur', side_threshold=(0,10000), terminal_threshold=(0, 10000), mismatch_threshold=(0, 10000), fig_save_path=data_path)
  #feature.visualize_beta_sheet_features('all', 'phi', feature2='psi', side_threshold=(1,10000), terminal_threshold=(1, 10000), mismatch_threshold=(1, 10000), hist_dump_path=data_path)
